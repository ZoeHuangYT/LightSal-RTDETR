...
def bbox_effciou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, EfficiCIoU=False, eps=1e-7):
    ...
    # IoU
    iou = inter / union
    if CIoU or DIoU or GIoU or EfficiCIoU:
        ...
        # return iou - rho2 / c2, wasserstein # NWDLoss
        elif EfficiCIoU:
            c2 = cw ** 2 + ch ** 2 + eps  # convex diagonal squared
